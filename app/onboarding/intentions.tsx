...
export default function IntentionsScreen() {
  ...
  const handleContinue = () => {
    ...
    if (isAuthenticated) {
      ...
      router.push('/onboarding/presentation' as never);
      return;
    }
  ...
  return (
    <View style={styles.root}>
      ...
      <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
        <OnboardingProgressHeader stepLabel="3/9" progress={3 / 9} />
        ...
        <OnboardingEntrance>
          <View style={styles.content}>
            ...
            <View style={styles.footer}>
              ...
              <TactilePressable onPress={handleContinue} style={styles.continueButton}>
