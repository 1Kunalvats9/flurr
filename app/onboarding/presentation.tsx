...
export default function PresentationScreen() {
  ...
  const { presentation, setPresentation } = useUser();
  ...
  const handleContinue = () => {
    ...
    router.push('/onboarding/presentation-preference' as never);
  };
  ...
  const handleBack = () => {
    ...
    router.replace('/onboarding/intentions' as never);
  };
  ...
  return (
    <View style={styles.root}>
      ...
      <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
        <OnboardingProgressHeader stepLabel="4/9" progress={4 / 9} />

        <OnboardingEntrance>
          <View style={styles.content}>
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
              <Text style={styles.heading}>which presentation do you identify w/ the most rn?</Text>
