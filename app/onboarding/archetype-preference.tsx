...
export default function ArchetypePreferenceScreen() {
  const router = useRouter();
  const { archetypePreferences, setArchetypePreferences } = useUser();
  const [selected, setSelected] = useState<string[]>(archetypePreferences);
  ...
  const handleContinue = () => {
    ...
    setArchetypePreferences(selected);
  ...
  return (
    <View style={styles.root}>
      ...
      <SafeAreaView style={styles.safeArea} edges={['top', 'bottom']}>
        <OnboardingProgressHeader stepLabel="7/9" progress={7 / 9} />
        ...
        <OnboardingEntrance>
          <View style={styles.container}>
            <ScrollView
              ...
              <Text style={styles.heading}>cute, ok what vibe(s) ru most drawn to?</Text>
